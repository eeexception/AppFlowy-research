  ...
  group('AppFlowyClient', () {
    ...
    group('GET requests', () {
      ...
      test('should include auth token in headers if set', () async {
        ...
        // verify(mockDio.get(
        //   any,
        //   options: argThat(predicate<Options>((opts) =>
    ...
    group('PUT requests', () {
      test('should make PUT request with data', () async {
        ...
        //
        // verify(mockDio.put(
        //   'https://api.appflowy.io/test/123',
        //   data: {'name': 'Updated'},
        // )).called(1);
      });
    });
    ...
    group('DELETE requests', () {
      test('should make DELETE request', () async {
        ...
        //
        // verify(mockDio.delete('https://api.appflowy.io/test/123')).called(1);
      });
    });
